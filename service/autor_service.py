...
class AutorService:
    ...
    def adicionar(self):
        ...
        try:
            ...
            bio = input('Insira uma breve biografia do autor: ')
    ...
    def mostrar_por_id(self):
        ...
        try:
            ...
            cat = self.__autor_dao.buscar_por_id(id)


            if (cat == None):
                print('Autor não encontrado!')
            else:
                print(f'Id: {cat.id} | Autor: {cat.nome} | Telefone: {cat.telefone} | Email: {cat.email} | Bio: {cat.bio}')    
        except Exception as e:
